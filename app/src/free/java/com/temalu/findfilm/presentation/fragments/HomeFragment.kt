...
class HomeFragment : Fragment() {
    ...
    private lateinit var restartProVersion: FloatingActionButton
    ...
    private fun reactivateProVersion(){
        scene?.sceneRoot?.let {
            restartProVersion = it.findViewById<FloatingActionButton>(
                R.id.floatingActionButton)
        }
        restartProVersion.setOnClickListener {
            (requireActivity() as MainActivity).reactivateProVersion()
        }
    }
